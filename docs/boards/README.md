...
- **nicenano_v2** — nice!nano v2; same Adafruit serial-DFU family, secondary buses modeled, not yet re-verified on hardware here.
...
- **usb_dongle_nrf52840** — PCA10059 USB dongle; Nordic Open DFU, not the package's Adafruit serial-DFU path.
