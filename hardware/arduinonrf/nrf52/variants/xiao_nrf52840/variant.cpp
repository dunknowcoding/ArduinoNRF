...
const NrfBoardCapabilities g_boardCapabilities = {
    "XIAO-like nRF52840", "xiao-like", "not-applicable", "package-modeled", "undeclared", "undeclared", true, false, true, true, false, false, true, false, false, false, false, false, false, 1, 1
};

const uint8_t PINS_COUNT = 33;
...
const uint8_t PIN_QSPI_CS = 25;
const uint8_t PIN_QSPI_SCK = 26;
const uint8_t PIN_QSPI_IO0 = 27;
const uint8_t PIN_QSPI_IO1 = 28;
const uint8_t PIN_QSPI_IO2 = 29;
const uint8_t PIN_QSPI_IO3 = 30;
const uint8_t PIN_SERIAL_RX = 6;
const uint8_t PIN_SERIAL_TX = 7;
