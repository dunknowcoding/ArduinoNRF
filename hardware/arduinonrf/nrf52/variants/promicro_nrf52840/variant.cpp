...
const NrfBoardCapabilities g_boardCapabilities = {
    "AliExpress ProMicro nRF52840", "promicro-compatible", "package-modeled", "package-modeled", "schematic", "lfxo", true, true, false, false, false, false, false, false, false, false, false, false, false, 1, 1
};

const uint8_t PINS_COUNT = 30;
const uint8_t PIN_LED1 = LED_BUILTIN;
const uint8_t PIN_LED2 = LED_RED;
const uint8_t PIN_LED3 = LED_GREEN;
const uint8_t PIN_NEOPIXEL = 17;
