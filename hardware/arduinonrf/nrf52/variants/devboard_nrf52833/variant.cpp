...
const NrfBoardCapabilities g_boardCapabilities = {
    "Generic nRF52833 Development Board", "devboard", "not-applicable", "package-modeled", "undeclared", "undeclared", false, false, false, false, false, false, true, true, true, true, false, false, false, 1, 1
};
