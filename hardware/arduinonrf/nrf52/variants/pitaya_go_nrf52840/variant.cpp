...
const NrfBoardCapabilities g_boardCapabilities = {
    "Pitaya Go nRF52840", "handheld", "package-modeled", "package-modeled", "undeclared", "undeclared", true, true, true, true, true, true, false, false, false, false, false, false, false, 1, 1
};
...
const uint8_t PIN_NEOPIXEL = 22;
const uint8_t PIN_BUTTON1 = 11;
const uint8_t PIN_BUTTON2 = 12;
const uint8_t PIN_BATTERY = 28;
const uint8_t PIN_EXT_VCC = 255;
const uint8_t PIN_CHARGE_STATUS = 255;
const uint8_t PIN_QSPI_CS = 16;
const uint8_t PIN_QSPI_SCK = 17;
const uint8_t PIN_QSPI_IO0 = 18;
const uint8_t PIN_QSPI_IO1 = 19;
const uint8_t PIN_QSPI_IO2 = 20;
const uint8_t PIN_QSPI_IO3 = 21;
