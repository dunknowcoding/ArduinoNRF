...
#include "host_src/ble_gatt_priv.h"
#include "os/endian.h"
                                 ...
                                 struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    return os_mbuf_append(ctxt->om,
                          ...
                          sizeof(ble_svc_gatt_local_srv_sup_feat)) == 0
               ? 0
                                ...
                                struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    if (ctxt->op == BLE_GATT_ACCESS_OP_READ_CHR) {
        ...
        return os_mbuf_append(ctxt->om, &supported_feat,
                              sizeof(supported_feat)) == 0
                   ? 0
                   : BLE_ATT_ERR_INSUFFICIENT_RES;
    }
...
void ble_svc_gatt_init(void)
{
    ...
    if (MYNEWT_VAL(BLE_EATT_CHAN_NUM) > 0) {
        ble_svc_gatt_local_cl_sup_feat |=
            (1 << BLE_SVC_GATT_CLI_SUP_FEAT_EATT_BIT);
    }
